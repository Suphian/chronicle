        ...
        <figure>
          <a className={styles.artwork} href="/images/world/carthara-grand-study-v1.webp" target="_blank" rel="noreferrer" aria-label="Open the Carthara architectural study at full size">
            <Image
              ...
              data-motion-art
            />
            <span className={styles.viewDetail} aria-hidden="true">Explore the detail ↗</span>
          </a>
          <figcaption className={styles.caption}>
            <div>
              <p className={styles.eyebrow}>Stone, water & everyday life</p>
              <h2 id="carthara-study-title">Carthara · an architectural study</h2>
            </div>
            <p className={styles.note}>A vision of the city’s scale, gardens, and working waterfront. Its architecture and street plan are still being imagined.</p>
          </figcaption>
        </figure>
      </section>
