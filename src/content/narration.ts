...
export const voiceCast: Record<string, CastVoice> = {
  ...
  virello: { name: "Sinna", direction: "Measured scholarly clarity. A convincing teacher whose patience contracts when ownership or status is threatened.", lang: "en-GB", pitch: 0.9, rate: 0.91 },
  alethea: { name: "Alethea", direction: "Attentive and assured; gentle without yielding professional boundaries. Allow humor and disagreement.", lang: "en-GB", pitch: 1.08, rate: 0.97 },
  chuluun: { name: "Chuluun", direction: "An experienced Leonin with limited time and concrete obligations. Grounded, sometimes tired or angry; no growling caricature.", lang: "en-GB", pitch: 0.86, rate: 0.92 },
  phylios: { name: "Phylios", direction: "Accustomed to command, vulnerable when asking for his son's care.", lang: "en-GB", pitch: 0.9, rate: 0.96 },
  numarius: { name: "Numarius", direction: "Social ease and unhurried entitlement. Threats sound ordinary because he expects obedience.", lang: "en-GB", pitch: 0.9, rate: 0.93 },
  corvo: { name: "Corvo", direction: "Crisp, commercially precise, alert to practical consequences. Neither omniscient nor theatrically sinister.", lang: "en-GB", pitch: 0.97, rate: 1 },
  vael: { name: "Vael", direction: "Clipped, practical authority; listens for what can actually be done.", lang: "en-GB", pitch: 0.88, rate: 0.98 },
  rukhsana: { name: "Rukhsana", direction: "Plain, resourceful, willing to correct a king. Community obligations matter more than grandeur.", lang: "en-GB", pitch: 1.05, rate: 0.97 },
  iskandar: { name: "Iskandar", direction: "Confident young command, easily wounded in public. Authority gradually loses its audience.", lang: "en-GB", pitch: 0.96, rate: 0.99 },
  ...
  man: { name: "Supporting man", direction: "Plain conversational delivery for unnamed men; do not imply they are one recurring character.", lang: "en-GB", pitch: 1, rate: 1 },
  child: { name: "Young supporting speaker", direction: "Young, natural delivery for the messenger, junior guard, and apprentice; let urgency or hesitation follow the scene without comic exaggeration.", lang: "en-GB", pitch: 1.2, rate: 1.03 },
  guard: { name: "Guard / sergeant", direction: "Practical official delivery; individual orders and doubts, not a constant shout.", lang: "en-GB", pitch: 0.91, rate: 1 },
  clerk: { name: "Clerk / collector", direction: "Matter-of-fact administrative certainty. No elaborate villain performance.", lang: "en-GB", pitch: 0.98, rate: 0.96 },
  broker: { name: "Broker", direction: "A clear negotiator conscious of risk and the limits of promises.", lang: "en-GB", pitch: 0.96, rate: 1 },
};
...
export const dialogueRevisions: Record<string, string> = {
  ...
  "journeys/tengeri-wastes": "31b409d5",
