...
/** Story places. Source-map positions and regional anchors live in mizan.ts. */
export const world: WorldLocation[] = [
  ...
  },
  {
    ...
    description:
      "Canyon camps in the Tengeri region southwest of Carthara shelter Leonin driven from their homeland by the power now ruled under Numarius's name. Enslavement, enforced labor transfers, restricted movement, and repeated bombardment shape daily life. Displaced Leonin also live across the world, each carrying the lost home's flag. Camp councils, peace advocates, armed resistance, and diaspora networks disagree about the future. Chuluun is a displaced elder under a labor account himself; Hanno learns limited practical skills while helping his hosts.",
    type: "landmark",
