...
export const shadowsClosingIn: Chapter = {
  ...
  summary:
    "Elysian Dust hollows out the ruling class. Dyia hunts a mastermind through dead ends and misdirection, never suspecting that the trail is being erased by his own brother.",
  mood: "night",
  when: "Now",
  status: "draft",
  ...
  scenes: [
    ...
    },
    {
      ...
      text: [
        "Dyia becomes consumed. He tracks distribution patterns, conducts interrogations, pieces together clues. Every lead dissolves. The network behind the Dust is sophisticated, elusive, and frighteningly efficient.",
        "He does not know that his brother watches every step of his investigation, hiding evidence and bending trails. Watching Dyia's persistence fills Hanno with pride, sadness, and fear, all at once.",
    ...
    },
    {
      ...
      text: [
        "Numarius notices the rot at last: instability among the ruling class, productivity falling, whispers he cannot silence. Indifferent no longer, he presses Dyia to end it.",
    ...
    },
    {
      ...
      mood: "void",
      text: [
        "Slowly, Dyia uncovers unsettling connections: whispers of betrayal, signs that someone deeply influential sits behind the epidemic. With dread, he begins to suspect Numarius's own circle.",
    ...
    },
    {
      ...
      text: [
        "Shadows close in around the brothers. Hanno's calculated cruelty and Dyia's unwavering pursuit are two edges of the same spear.",
