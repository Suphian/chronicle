...
export const codex: CodexEntry[] = [
  ...
  { id: "alethea", name: "Alethea", kind: "person", role: "Hanno's wife. Healer of Lysandria.", body: "Serene, respected, and wiser than her husband. She left the mountains with him and has never asked what is in the shipments. She wore the Elysian flower in her hair on their wedding night.", chapter: "gift-of-lysandria" },
  ...
  { id: "elysian-dust", name: "Elysian Dust", kind: "substance", role: "Hanno's poison. Euphoria at a ruinous price.", body: "Distilled from the Elysian flower that Hanno placed in his wife's hair. Moved through a network of merchants who do not know what they carry. Currently hollowing out the ruling class of Carthara.", chapter: "a-dark-turn" },
