...
export const codex: CodexEntry[] = [
  // ---- People
  { id: "hanno", name: "Hanno Averroes", kind: "person", role: "Alchemist, merchant, and schemer.", body: "Eldest son of Adil and Amara. A gifted practitioner whose danger comes from preparation, manipulation, and his willingness to harm. He can defend himself with a staff, but an experienced fighter can outmatch him. Celebrated for treating Ravash dependence, he becomes the concealed maker of Elysian Dust.", chapter: "market-awnings" },
  ...
  { id: "chuluun", name: "Chuluun", kind: "person", role: "Displaced Leonin elder, laborer, and keeper of camp records.", body: "A lion-man driven from his homeland, living under an enforced labor account in the Tengeri refugee camps. He keeps one shelter row's missing-person records and helps the Return Councils. He has fought, but refuses to make every civilian a fighter or every claim of resistance immune to question. He carries his homeland's flag and teaches Hanno modest practical skills while asking him to bear truthful witness.", chapter: "journeys" },
  ...
  { id: "the-leonin", name: "The Leonin Clans", kind: "faction", role: "Displaced lion-folk, divided in politics and joined by a lost home.", body: "The Leonin once welcomed Numarius's people as refugees after their homeland was destroyed, then suffered dispossession by the people they had sheltered. Many are enslaved; the Tengeri camps endure bombardment, while diaspora communities live throughout the world. Every Leonin carries the lost home's flag. Some seek negotiated peace, others resistance to the death; councils and diaspora networks have their own priorities. Powerful interests spread false accounts and apply the terrorist label to the whole people.", chapter: "journeys" },
