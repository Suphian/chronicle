...
export const codex: CodexEntry[] = [
  ...
  { id: "chuluun", name: "Chuluun", kind: "person", role: "Displaced Leonin elder, laborer, and keeper of camp records.", body: "A Leonin driven from his homeland, living under an enforced labor account in the Tengeri refugee camps. He keeps one shelter row's missing-person records and helps the Return Councils. He has fought, but refuses to make every civilian a fighter or every claim of resistance immune to question. He carries his homeland's flag and teaches Hanno modest practical skills while asking him to bear truthful witness.", chapter: "journeys" },
